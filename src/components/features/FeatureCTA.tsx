    ...
    delay: 0.5
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button onClick={() => navigate("/login")} size="lg" className="bg-white text-rose-500 hover:bg-white/10 transition-all duration-300 transform hover:scale-105 font-semibold">
            Créer un Compte
          </Button>
          <Button onClick={() => navigate("/login")} size="lg" variant="outline" className="bg-transparent border-2 border-white text-white hover:bg-white/10 transition-all duration-300 transform hover:scale-105 font-semibold">
            Se Connecter
          </Button>
        </div>
      </div>
