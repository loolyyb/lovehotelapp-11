        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            field
                  ...
                  <FormControl>
                    <Input placeholder="Votre nom" {...field} className="bg-white/90 border-white/20 placeholder:text-gray-500" />
                  </FormControl>
            ...
            field
                  ...
                  <FormControl>
                    <Input type="email" placeholder="votre@email.com" {...field} className="bg-white/90 border-white/20 placeholder:text-gray-500" />
                  </FormControl>
                  <FormMessage className="text-[#F3EBAD]" />
                </FormItem>} />
            ...
            field
                  ...
                  <FormControl>
                    <Textarea placeholder="Votre message" className="min-h-[120px] border-white/20 placeholder:text-gray-500 bg-zinc-800" />
                  </FormControl>
                  <FormMessage className="text-[#F3EBAD]" />
                </FormItem>} />

            <Button type="submit" className="w-full bg-white/10 hover:bg-white/20 text-[#F3EBAD] border-2 border-[#F3EBAD] transition-all duration-300 transform hover:scale-105 font-semibold mt-6">
              Envoyer le message
            </Button>
          </form>
        </Form>
