    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-[#2A2726] border-t border-white/20 px-2 py-1 z-50">
      <div className="flex justify-around items-center">
        ...
        <Link
          to="/profiles"
          className={`flex flex-col items-center p-2 transition-colors duration-200 ${
            isActive("/profiles") ? "text-rose-400" : "text-white hover:text-rose-200"
          }`}
        >
        ...
        <Link
          to="/rideaux-ouverts"
          className={`flex flex-col items-center p-2 transition-colors duration-200 ${
            isActive("/rideaux-ouverts") ? "text-rose-400" : "text-white hover:text-rose-200"
          }`}
        >
        ...
        <Link
          to="/lover-coin"
          className={`flex flex-col items-center p-2 transition-colors duration-200 ${
            isActive("/lover-coin") ? "text-rose-400" : "text-white hover:text-rose-200"
          }`}
        >
