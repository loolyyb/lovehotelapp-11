...
export function AccountTab({ profile, onUpdate }: AccountTabProps) {
  ...
  const handleDatingProfileChange = (checked: boolean) => {
    ...
    toast({
      ...
      description: checked 
        ? "Votre profil est maintenant visible dans la section Rencontres" 
        : "Votre profil n'est plus visible dans la section Rencontres",
    });
  };
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between space-x-2">
            ...
            <Switch
              ...
              onCheckedChange={handleDatingProfileChange}
            />
          </div>
