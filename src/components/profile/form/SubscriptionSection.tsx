              ...
              <div className="relative space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-600">Total: <span className="font-semibold">{card.total || 0}</span></p>
                    <p className="text-sm text-gray-600">Utilisations: <span className="font-semibold">{card.usageCount || 0}</span></p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {card.created && (
                    <p className="text-sm text-gray-600">
                      ...
                      {format(new Date(card.created), "d MMMM yyyy", { locale: fr })}
                    </p>
                  )}
                </div>
              </div>
